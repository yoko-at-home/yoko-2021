...
export const Button: FC<InputType> = (props) => {
  return (
    <button aria-label="Move to Link">
      <span className="group relative py-3 px-6 font-bold text-white rounded-lg">
...
export const Button2: FC<InputType> = (props) => {
  return (
    <button aria-label="Move to Link">
      <span className="group relative py-3 px-6 font-bold text-white rounded-lg">
...
export const ButtonYellow: FC<InputType> = (props) => {
  return (
    <span className="group relative py-3 px-6">
      ...
      <span className="relative font-bold text-blue-800">{props.children}</span>
    </span>
  );
};
export const ButtonSmall: FC<InputType> = (props) => {
  return (
    <a
      href={props.src}
      target="_blank"
